...
class Case(models.Model):
    ...
    '''
	week_food = models.BooleanField('(IGNORE) Needs Short-Term Food Assistance: "Do you have enough food for the week?" (If the answer is NO, check the box)', default=False)
    semester_food = models.BooleanField('(IGNORE) Needs Long-Term Food Assistance: "Do you have enough food for the duration of the semester?" (If the answer is NO, check the box)', default=False)
    week_housing = models.BooleanField('(IGNORE) Needs Housing Assistance: "Do you have a safe and stable home for tonight and the rest of this week?" (If the answer is NO, check the box)', default=False)
    dependent = models.BooleanField('(IGNORE) Needs Dependent Assistance: "Are you financially supporting another person?" (Child, parent, significant other, etc.) (If the answer is YES, check the box)', default = False)
    screening_asked = models.BooleanField('(IGNORE) I asked the client the basic needs screening questions above', default=False)
    '''
    week_food = models.BooleanField('(IGNORE)', default=False)
    semester_food = models.BooleanField('(IGNORE)', default=False)
    week_housing = models.BooleanField('(IGNORE)', default=False)
    dependent = models.BooleanField('(IGNORE)', default = False)
    screening_asked = models.BooleanField('(IGNORE)', default=False)
